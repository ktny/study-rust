...
Promise.all([mandelbrot]).then(async function ([
    {generate_mandel_brot_set, draw_mandelbrot_set}
]) {
    ...
    renderBtn.addEventListener("click", () => {
        ...
        let wasmResult = null;
        {
            ...
            wasmResult = generate_mandel_brot_set(canvasWidth, canvasHeight, X_MIN, X_MAX, Y_MIN, Y_MAX, MAX_ITER);
